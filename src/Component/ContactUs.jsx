    ...
    return (
        <div className="max-w-4xl mx-auto p-6 mt-16 ">
            ...
            <div className="mt-8 text-center">
                <h2 className="text-xl font-bold text-gray-800">Our Contact Information</h2>
                <p className="text-gray-700 mt-2">📍 123 Marathon Street, Runner City, USA</p>
                <p className="text-gray-700">📧 support@raceflow.com</p>
